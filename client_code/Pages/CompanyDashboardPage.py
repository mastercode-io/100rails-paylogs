    ...
    def __init__(self, container_id, **kwargs):
        ...
        total_staff_widget_content = f'\
            <div style="padding: 10px; height:100%;">\
                <div height="100%" style="border: 1px solid; border-radius: 5px; background-color:lightgrey; \
                height:100%; text-align:center; ">\
                    <h4>Total Staff This Pay</h4>\
                    <h1>1,400</h1>\
                    <p style="font-size: 20px;color: green;"><i class="fa-solid fa-triangle"></i>nbsp;nbsp;nbsp;Up by 3</p>\
                </div>\
            </div>'
